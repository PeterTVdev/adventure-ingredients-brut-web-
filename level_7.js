...
class Level_7 {
    ...
    RelanceNiveau() {
        ...
        this.sprBat[1] = new Sprite(this.imgLoader[1], 6*TUILE_WIDTH, 3*TUILE_HEIGHT);
    ...
    ennemy_update() {
        Chauve_sourie.addMechant(0, 23, 100, 155, 90, 350, 350, rnd(75, 100));
        big_Boss.addMechant(0, 39, 100, 500, 250, 1000, 1000, rnd(300, 450));
    ...
    update(dt) {
        ...
        if (Map[6][this.sprHero.y/TUILE_HEIGHT][this.sprHero.x/TUILE_WIDTH] == 0) {
            robe_right = false;
            robe_down = false;
            robe_left = false;
            robe_up = false;
