...
class Level_5 {
    ...
    load(pLoader) {
        ...
        //Dessine le boss
        this.sprBoss = new Sprite(this.imgLoader[2], 9*TUILE_WIDTH, 1*TUILE_HEIGHT);
    ...
    ennemy_update() {
        Chauve_sourie.addMechant(0, 23, 100, 100, 45, 180, 180, rnd(50, 60));
        big_Boss.addMechant(0, 39, 100, 300, 155, 450, 450, rnd(200, 250));
    ...
    update(dt) {
        ...
        if (Map[4][this.sprHero.y/TUILE_HEIGHT][this.sprHero.x/TUILE_WIDTH] == 0) {
            robe_right = false;
            robe_down = false;
            robe_left = false;
            robe_up = false;
