...
class Level_4 {
    ...
    ennemy_update() {
        Chauve_sourie.addMechant(0, 23, 100, 75, 40, 125, 125, rnd(40, 60));
        big_Boss.addMechant(0, 39, 100, 210, 120, 300, 300, rnd(150, 250));
    ...
    update(dt) {
        ...
        if (Map[3][this.sprHero.y/TUILE_HEIGHT][this.sprHero.x/TUILE_WIDTH] == 0) {
            robe_right = false;
            robe_down = false;
            robe_left = false;
            robe_up = false;
