...
class Level_1 {
    ...
    RelanceNiveau() {
        ...
        this.sprBat[0] = new Sprite(this.imgLoader[1], 6*TUILE_WIDTH, 3*TUILE_HEIGHT);
        this.sprBat[1] = new Sprite(this.imgLoader[1], 6*TUILE_WIDTH, 6*TUILE_HEIGHT);
        this.sprBat[2] = new Sprite(this.imgLoader[1], 8*TUILE_WIDTH, 1*TUILE_HEIGHT);
    ...
    ennemy_update() {
        Chauve_sourie.addMechant(0, 15, 100, 4, 0, 25, 25, rnd(20, 30));
        big_Boss.addMechant(0, 35, 100, 14, 3, 80, 80, rnd(105, 155));
    ...
    update(dt) {
        ...
        if (Map[0][this.sprHero.y/TUILE_HEIGHT][this.sprHero.x/TUILE_WIDTH] == 0) {
            robe_right = false;
            robe_down = false;
            robe_left = false;
            robe_up = false;
