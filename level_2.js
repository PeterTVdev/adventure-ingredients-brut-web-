...
class Level_2 {
    ...
    RelanceNiveau() {
        ...
        this.sprBat[0] = new Sprite(this.imgLoader[1], 3*TUILE_WIDTH, 1*TUILE_HEIGHT);
        this.sprBat[1] = new Sprite(this.imgLoader[1], 4*TUILE_WIDTH, 6*TUILE_HEIGHT);
        this.sprBat[2] = new Sprite(this.imgLoader[1], 6*TUILE_WIDTH, 2*TUILE_HEIGHT);
        this.sprBat[3] = new Sprite(this.imgLoader[1], 8*TUILE_WIDTH, 6*TUILE_HEIGHT);
    ...
    load(pLoader) {
        ...
        //Dessine le boss
        this.sprBoss = new Sprite(this.imgLoader[2], 12*TUILE_WIDTH, 6*TUILE_HEIGHT);
    ...
    ennemy_update() {
        Chauve_sourie.addMechant(0, 20, 100, 23, 10, 45, 45, rnd(30, 45));
        big_Boss.addMechant(0, 37, 100, 47, 31, 125, 125, rnd(100, 200));
    ...
    update(dt) {
        ...
        if (Map[1][this.sprHero.y/TUILE_HEIGHT][this.sprHero.x/TUILE_WIDTH] == 0) {
            robe_right = false;
            robe_down = false;
            robe_left = false;
            robe_up = false;
