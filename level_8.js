...
class Level_8 {
    ...
    RelanceNiveau() {
        ...
        this.sprBat[0] = new Sprite(this.imgLoader[1], 3*TUILE_WIDTH, 3*TUILE_HEIGHT);
        this.sprBat[1] = new Sprite(this.imgLoader[1], 5*TUILE_WIDTH, 3*TUILE_HEIGHT);
        this.sprBat[2] = new Sprite(this.imgLoader[1], 9*TUILE_WIDTH, 3*TUILE_HEIGHT);
        this.sprBat[3] = new Sprite(this.imgLoader[1], 6*TUILE_WIDTH, 1*TUILE_HEIGHT);
        this.sprBat[4] = new Sprite(this.imgLoader[1], 10*TUILE_WIDTH, 1*TUILE_HEIGHT);
        this.sprBat[5] = new Sprite(this.imgLoader[1], 4*TUILE_WIDTH, 5*TUILE_HEIGHT);
        this.sprBat[6] = new Sprite(this.imgLoader[1], 9*TUILE_WIDTH, 6*TUILE_HEIGHT);
    ...
    load(pLoader) {
        ...
        //Dessine le hero
        this.sprHero = new Sprite(this.imgLoader[0], 1*TUILE_WIDTH, 3*TUILE_HEIGHT);
        ...
        //Dessine le boss
        this.sprBoss = new Sprite(this.imgLoader[2], 12*TUILE_WIDTH, 3*TUILE_HEIGHT);
    ...
    ennemy_update() {
        Chauve_sourie.addMechant(0, 23, 100, 200, 125, 500, 500, rnd(90, 115));
        big_Boss.addMechant(0, 39, 100, 722, 400, 1250, 1250, rnd(400, 450));
    ...
    update(dt) {
        ...
        if (Map[7][this.sprHero.y/TUILE_HEIGHT][this.sprHero.x/TUILE_WIDTH] == 0) {
            robe_right = false;
            robe_down = false;
            robe_left = false;
            robe_up = false;
