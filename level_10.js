...
class Level_10 {
    ...
    RelanceNiveau() {
        ...
        this.sprBat[2] = new Sprite(this.imgLoader[1], 7*TUILE_WIDTH, 3*TUILE_HEIGHT);
        this.sprBat[3] = new Sprite(this.imgLoader[1], 9*TUILE_WIDTH, 3*TUILE_HEIGHT);
        this.sprBat[4] = new Sprite(this.imgLoader[1], 11*TUILE_WIDTH, 3*TUILE_HEIGHT);
    ...
    ennemy_update() {
        Chauve_sourie.addMechant(0, 23, 100, 370, 250, 2000, 2000, rnd(300, 500));
        big_Boss.addMechant(0, 39, 100, 1500, 700, 3500, 3500, rnd(700, 1500));
    ...
    update(dt) {
        ...
        if (Map[9][this.sprHero.y/TUILE_HEIGHT][this.sprHero.x/TUILE_WIDTH] == 0) {
            robe_right = false;
            robe_down = false;
            robe_left = false;
            robe_up = false;
