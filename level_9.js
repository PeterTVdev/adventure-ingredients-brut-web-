...
class Level_9 {
    ...
    RelanceNiveau() {
        ...
        this.sprBat[4] = new Sprite(this.imgLoader[1], 7*TUILE_WIDTH, 5*TUILE_HEIGHT);
    ...
    ennemy_update() {
        Chauve_sourie.addMechant(0, 23, 100, 310, 200, 900, 900, rnd(150, 300));
        big_Boss.addMechant(0, 39, 100, 900, 550, 1700, 1700, rnd(500, 700));
    ...
    update(dt) {
        ...
        if (Map[8][this.sprHero.y/TUILE_HEIGHT][this.sprHero.x/TUILE_WIDTH] == 0) {
            robe_right = false;
            robe_down = false;
            robe_left = false;
            robe_up = false;
