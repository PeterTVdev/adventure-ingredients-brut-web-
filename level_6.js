...
class Level_6 {
    ...
    RelanceNiveau() {
        ...
        this.sprBat[0] = new Sprite(this.imgLoader[1], 3*TUILE_WIDTH, 2*TUILE_HEIGHT);
        this.sprBat[1] = new Sprite(this.imgLoader[1], 2*TUILE_WIDTH, 4*TUILE_HEIGHT);
        this.sprBat[2] = new Sprite(this.imgLoader[1], 1*TUILE_WIDTH, 6*TUILE_HEIGHT);
        this.sprBat[3] = new Sprite(this.imgLoader[1], 5*TUILE_WIDTH, 6*TUILE_HEIGHT);
        this.sprBat[4] = new Sprite(this.imgLoader[1], 12*TUILE_WIDTH, 6*TUILE_HEIGHT);
        this.sprBat[5] = new Sprite(this.imgLoader[1], 12*TUILE_WIDTH, 4*TUILE_HEIGHT);
        this.sprBat[6] = new Sprite(this.imgLoader[1], 12*TUILE_WIDTH, 2*TUILE_HEIGHT);
        this.sprBat[7] = new Sprite(this.imgLoader[1], 10*TUILE_WIDTH, 3*TUILE_HEIGHT);
        this.sprBat[8] = new Sprite(this.imgLoader[1], 9*TUILE_WIDTH, 4*TUILE_HEIGHT);
        this.sprBat[9] = new Sprite(this.imgLoader[1], 6*TUILE_WIDTH, 4*TUILE_HEIGHT);
        this.sprBat[10] = new Sprite(this.imgLoader[1], 9*TUILE_WIDTH, 1*TUILE_HEIGHT);
    ...
    load(pLoader) {
        ...
        //Dessine le hero
        this.sprHero = new Sprite(this.imgLoader[0], 5*TUILE_WIDTH, 1*TUILE_HEIGHT);
        ...
        //Dessine le boss
        this.sprBoss = new Sprite(this.imgLoader[2], 4*TUILE_WIDTH, 4*TUILE_HEIGHT);
    ...
    ennemy_update() {
        Chauve_sourie.addMechant(0, 23, 100, 120, 60, 210, 210, rnd(50, 80));
        big_Boss.addMechant(0, 39, 100, 350, 190, 700, 700, rnd(210, 300));
    ...
    update(dt) {
        ...
        if (Map[5][this.sprHero.y/TUILE_HEIGHT][this.sprHero.x/TUILE_WIDTH] == 0) {
            robe_right = false;
            robe_down = false;
            robe_left = false;
            robe_up = false;
